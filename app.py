...
def make_plot(src):
    p = figure(x_range=["Current Law", "TCJA Repeal", "SALT Cap Repeal"], plot_height=300, plot_width=500, toolbar_location=None)
    p.vbar(source=src, x='x_vals', top='itax', fill_color= '#ff7f0e',color='#ff7f0e', hover_fill_color='#ff7f0e',hover_fill_alpha=0.8, width=0.3, fill_alpha=0.5)
...
wages_button = RadioButtonGroup(labels=['$10,000', '$20,000', '$40,000', '$60,000', '$80,000', '$100,000', '$200,000', '$500,000', '$1,000,000', '$5,000,000'], active=3)
salt_button = RadioButtonGroup(labels=['$0', '$2,000', '$5,000', '$10,000', '$20,000', '$30,000', '$50,000', '$100,000'], active=0)
item_button = RadioButtonGroup(labels=['$0', '$2,000', '$5,000', '$10,000', '$20,000', '$30,000', '$50,000', '$100,000'], active=0)
...
controls = WidgetBox(space, mstat_button, deps_button, wages_title, wages_button, salt_title, salt_button, item_title, item_button)
